...
4. [Convert PDFs to images](#4-convert-pdfs-to-images)  
5. [Preprocess (lightly clean up) the images](#5-preprocess-lightly-clean-up-the-images)  
6. [Run OCR two ways: EasyOCR and TrOCR](#6-run-ocr-two-ways-easyocr-and-trocr)  
7. [Turn raw text into fields](#7-turn-raw-text-into-fields)  
